...
export class TrainingProcessor extends BaseProcessor {
     ...
     */
    private processWeek(weekKey: string, weekDays: CalendarDay[], trainingData: TrainingData): WeeklyMetrics {
     ...
     */
    private formatTrainingDay(day: CalendarDay, index: number, trainingData: TrainingData): DailyMetrics {
     ...
     */
    private formatExercise(exercise: Exercise, exerciseSet: ExerciseSet, approaches: ExerciseSetApproach[]): FormattedExercise {
